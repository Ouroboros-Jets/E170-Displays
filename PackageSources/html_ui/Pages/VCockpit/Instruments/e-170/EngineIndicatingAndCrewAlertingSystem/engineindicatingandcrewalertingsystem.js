...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var SimVarProvider = ({ children }) => {
    ...
    useUpdate((deltaTime) => {
      ...
      setCache((oldCache) => {
        const newCache = {};
        for (const [key, update2] of Object.entries(stateUpdates)) {
          newCache[key] = __spreadValues(__spreadValues({}, oldCache[key]), update2);
        }
        return __spreadValues(__spreadValues({}, oldCache), newCache);
      });
    });
    const getKey = (name, unit, global) => `${global ? "_GLOBAL_" : ""}${name}/${normalizeUnitName(unit)}`;
  ...
  var IttGauge = (props) => {
    ...
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "itt-gauge-container-absolute", style: { left: `${props.left}px`, top: `${props.top}px` } }, /* @__PURE__ */ import_react7.default.createElement("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg" }, props.invalid ? null : /* @__PURE__ */ import_react7.default.createElement("g", { transform: `rotate(-135 50 50)` }, /* @__PURE__ */ import_react7.default.createElement(
      "path",
      {
        id: "filler",
    ...
    )), /* @__PURE__ */ import_react7.default.createElement("circle", { cx: 50, cy: 50, r: 35, stroke: "white", "stroke-width": 2, fill: "transparent" }), props.invalid ? null : /* @__PURE__ */ import_react7.default.createElement("g", { transform: `rotate(-135 50 50)` }, /* @__PURE__ */ import_react7.default.createElement(
      "path",
      {
    ...
    ), /* @__PURE__ */ import_react7.default.createElement("g", { transform: `rotate(${limiter(props.hardLimit, props.ittValue) / props.scaling} 50 50)` }, /* @__PURE__ */ import_react7.default.createElement(
      "path",
      {
    ...
    ))), /* @__PURE__ */ import_react7.default.createElement("circle", { cx: 50, cy: 50, r: 3, stroke: "white", strokeWidth: 1, fill: "black" }), props.fire ? /* @__PURE__ */ import_react7.default.createElement("g", null, /* @__PURE__ */ import_react7.default.createElement(
      "rect",
      {
        x: 30,
        y: 32.5,
    ...
    ), /* @__PURE__ */ import_react7.default.createElement("text", { x: 50, y: 50, textAnchor: "middle", fill: "white", fontSize: 15 }, "FIRE")) : null, /* @__PURE__ */ import_react7.default.createElement("rect", { x: 25, y: 75, width: 50, height: 20, fill: "black", stroke: "white", strokeWidth: 2, strokeLinejoin: "round" }), /* @__PURE__ */ import_react7.default.createElement("text", { x: 50, y: 90, textAnchor: "middle", fill: `${props.invalid ? props.amberColor : props.limeColor}`, fontSize: 10 }, props.invalid == false ? props.ittValue.toFixed(0) : "----")));
  };
  ...
  var Engine = (props) => {
    ...
    ), /* @__PURE__ */ import_react8.default.createElement(N1Gauge, { n1Value: 0, redlineValue: 100, commandedN1: 0, thrustRatingAnnunciator: 1, invalid: false, attcsState: 0 })), /* @__PURE__ */ import_react8.default.createElement("div", { className: "flex-row" }, /* @__PURE__ */ import_react8.default.createElement(
      IttGauge,
      {
  ...
  render(/* @__PURE__ */ import_react10.default.createElement(EngineIndicatingAndCrewAlertingSystem, null));
})();
/*
object-assign
(c) Sindre Sorhus
...
registerInstrument('e-170-engineindicatingandcrewalertingsystem', InstrumentLogic);
