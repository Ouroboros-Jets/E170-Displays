...
export class LowAltitudeAwarenessDisplay extends DisplayComponent<LowAltitudeAwarenessDisplayProps> {
  ...
  private readonly grndBoxInsideClipPathRef =
    FSComponent.createRef<SVGRectElement>();
  private readonly grndBoxOutsideClipPathRef =
    FSComponent.createRef<SVGRectElement>();
  ...
  private readonly renderLines = (): JSX.Element[] => {
    ...
    for (
      let i = -clipPathHeight * 1.005;
      i < clipPathHeight * 1.005;
      i += this.offset
    ) {
      lines.push(
        <line
  ...
  private checkTape(): void {
    if (this.altAgl > 550) {
      ...
      this.grndBoxOutsideClipPathRef.instance.setAttribute(
        "height",
        ...
        <defs>
          <clipPath id="laadInsideClipPath">
            <rect
              ...
              width={82}
              height={0}
              ref={this.grndBoxInsideClipPathRef}
            />
          </clipPath>
          ...
          <clipPath id="laadClipPath">
            <rect
              ...
              width={82}
              height={0}
              ref={this.grndBoxOutsideClipPathRef}
            />
          </clipPath>
        </defs>
