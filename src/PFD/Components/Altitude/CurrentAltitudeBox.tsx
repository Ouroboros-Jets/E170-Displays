    ...
    sub
      ...
      .handle((alt) => {
        this.tenthDigitScrollRef.instance.setAttribute(
          "transform",
          `translate(${0 * verticalScrollsSpacing}, ${Math.max(
            ((alt / 10) % 10) * digitSpacing,
            0
          )})`
        );
        ...
        this.thousandsDigitScrollRef.instance.setAttribute(
          ...
          `translate(${-2 * verticalScrollsSpacing}, ${Math.max(
            Math.floor((alt / 1000) % 10) * digitSpacing,
            0
          )})`
        );
        ...
        this.tenThousandsDigitScrollRef.instance.setAttribute(
          "transform",
          `translate(${-3 * verticalScrollsSpacing}, ${Math.max(
            Math.floor((alt / 10000) % 10) * digitSpacing,
            0
          )})`
        );
      });
