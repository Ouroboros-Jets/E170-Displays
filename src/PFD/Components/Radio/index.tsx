...
export default class Radio extends DisplayComponent<T_RadioProps> {
  ...
  public onAfterRender(node: VNode): void {
    ...
    sub
      ...
      .whenChanged()
      .handle((comFreq) => {
        this.comFrequecyRef.instance.textContent = parseFloat(comFreq)
          .toFixed(2)
          .toString();
      });
    ...
    sub
      ...
      .handle((comStandByFreq) => {
        this.comStandByFrequecyRef.instance.textContent = parseFloat(
          comStandByFreq
        )
          .toFixed(2)
          .toString();
    ...
    sub
      ...
      .whenChanged()
      .handle((navFreq) => {
        this.navFrequecyRef.instance.textContent = parseFloat(navFreq)
          .toFixed(2)
          .toString();
      });
    ...
    sub
      ...
      .handle((navStandByFreq) => {
        this.navStandByFrequecyRef.instance.textContent = parseFloat(
          navStandByFreq
        )
          .toFixed(2)
          .toString();
    ...
    return (
      <g>
        ...
        <text
          ...
          font-size={20}
          text-anchor="start"
          ref={this.comStandByFrequecyRef}
        >
          ---
        </text>
        <rect
        ...
        <text
          ...
          font-size={20}
          text-anchor="start"
          ref={this.navStandByFrequecyRef}
        >
          ---
        </text>
      </g>
