...
type T_AttitudeForegroundProps = {
  bank: number
  pitch: number
}

export const AttitudeForeground = (props: T_AttitudeForegroundProps): JSX.Element => {
      ...
      <g clipPath="url(#attitude-clip)">
        <g transform={`rotate(${props.bank}, 275, 255)`}>
          <g transform={`translate(0,${getTranslation().value * 8.6})`}>
            ...
            {isHorizonMarkerActive() && (
              <rect x="0" y="252" width="600" height="4" fill="white" stroke="black" strokeWidth={1} />
            )}
          </g>
