  ...
  return (
    <g transform={`rotate(${props.bank}, 275, 255)`}>
      <linearGradient id="SkyGradiant" x1="0" x2="0" y1="0" y2="1">
        <stop offset="0%" stopColor="#020383" />
        <stop offset="88%" stopColor="#020383" />
        <stop offset="100%" stopColor="#1717cf" />
      </linearGradient>
      <linearGradient id="GroundGradiant" x1="0" x2="0" y1="0" y2="1">
        <stop offset="0%" stopColor="#674200" />
        <stop offset="25%" stopColor="#352200" />
        <stop offset="100%" stopColor="#352201" />
      </linearGradient>
