...
export const Compass: FC<T_CompassProps> = (props: T_CompassProps): JSX.Element => {
    ...
    switch (tickType) {
      ...
      case tickTypes.NUMBERED:
        return (
          <g transform={`rotate(${rotation}, 300, 314)`}>
            <path d="M 300, 49 L 300 65" stroke="white" strokeWidth={3} />
            <text textAnchor="middle" x={300} y={95} fontSize={25} fontWeight="bold" fill="white">
              {fixNumbers(rotation)}
            </text>
          </g>
        )
  ...
  return (
    <g>
      <g transform={`rotate(${-props.heading}, 300, 314)`}>
        <circle cx={300} cy={314} r={265} fill="transparent" stroke="white" strokeWidth={3} />
        {drawCompassTicks(compassArray)}
      </g>

      <circle cx={300} cy={314} r={130} fill="transparent" stroke="white" strokeWidth={3} />
      <g transform="rotate(-60, 300, 314)">
        <path d="M300,174 L 300 194" strokeLinecap="round" stroke="white" strokeWidth={3} />
      </g>
      <g transform="rotate(60, 300, 314)">
        <path d="M300,174 L 300 194" strokeLinecap="round" stroke="white" strokeWidth={3} />
      </g>
